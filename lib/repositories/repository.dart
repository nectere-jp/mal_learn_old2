...
import 'package:mal_learn/repositories/chat_room_repository.dart';
...
class Repository {
  ...
  late final chatRoomRepository = ChatRoomRepository(read, watch);
  ...
  //chat room
  late final sendMessage = chatRoomRepository.sendMessage;
}
